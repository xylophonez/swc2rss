...
class HandlerBasedContract {
    ...
    callingContract = null) {
        ...
        this.evaluationOptions = new _smartweave_1.DefaultEvaluationOptions();
    ...
    async writeInteraction(input, tags = [], transfer = _smartweave_1.emptyTransfer) {
        if (!this.wallet) {
            throw new Error("Wallet not connected. Use 'connect' method first.");
        }
        this.maybeClearNetworkInfo();
        const { arweave } = this.smartweave;
        const interactionTx = await (0, _smartweave_1.createTx)(this.smartweave.arweave, this.wallet, this.contractTxId, input, tags, transfer.target, transfer.winstonQty);
