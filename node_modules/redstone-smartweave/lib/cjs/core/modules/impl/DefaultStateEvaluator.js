    ...
    async doReadState(missingInteractions, baseState, executionContext, currentTx) {
        ...
        for (const missingInteraction of missingInteractions) {
            ...
            if (state !== null) {
                ...
                currentState = (0, _smartweave_1.deepCopy)(result.state);
                this.logger.debug('Interaction evaluation', singleInteractionBenchmark.elapsed());
            }
            await this.onStateUpdate(currentInteraction, executionContext, new _smartweave_1.EvalStateResult(currentState, validity));
        ...
        return new _smartweave_1.EvalStateResult(currentState, validity);
    }
